...
public class CustomerController {
	...
	public CustomerDto update(@PathVariable(name="customerId") int customerId,
			@RequestBody CustomerDto updatedInfo) {
		return customerService.update(updatedInfo, customerId);
	}
